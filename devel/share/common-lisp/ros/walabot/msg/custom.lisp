...
(cl:defmethod cl:initialize-instance :after ((m <custom>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'custom)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name walabot-msg:<custom> is deprecated: use walabot-msg:custom instead.")))

(cl:ensure-generic-function 'R_Min-val :lambda-list '(m))
(cl:defmethod R_Min-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:R_Min-val is deprecated.  Use walabot-msg:R_Min instead.")
  (R_Min m))

(cl:ensure-generic-function 'R_Max-val :lambda-list '(m))
(cl:defmethod R_Max-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:R_Max-val is deprecated.  Use walabot-msg:R_Max instead.")
  (R_Max m))

(cl:ensure-generic-function 'R_Res-val :lambda-list '(m))
(cl:defmethod R_Res-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:R_Res-val is deprecated.  Use walabot-msg:R_Res instead.")
  (R_Res m))

(cl:ensure-generic-function 'Theta_Min-val :lambda-list '(m))
(cl:defmethod Theta_Min-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Theta_Min-val is deprecated.  Use walabot-msg:Theta_Min instead.")
  (Theta_Min m))

(cl:ensure-generic-function 'Theta_Max-val :lambda-list '(m))
(cl:defmethod Theta_Max-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Theta_Max-val is deprecated.  Use walabot-msg:Theta_Max instead.")
  (Theta_Max m))

(cl:ensure-generic-function 'Theta_Res-val :lambda-list '(m))
(cl:defmethod Theta_Res-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Theta_Res-val is deprecated.  Use walabot-msg:Theta_Res instead.")
  (Theta_Res m))

(cl:ensure-generic-function 'Phi_Min-val :lambda-list '(m))
(cl:defmethod Phi_Min-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Phi_Min-val is deprecated.  Use walabot-msg:Phi_Min instead.")
  (Phi_Min m))

(cl:ensure-generic-function 'Phi_Max-val :lambda-list '(m))
(cl:defmethod Phi_Max-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Phi_Max-val is deprecated.  Use walabot-msg:Phi_Max instead.")
  (Phi_Max m))

(cl:ensure-generic-function 'Phi_Res-val :lambda-list '(m))
(cl:defmethod Phi_Res-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Phi_Res-val is deprecated.  Use walabot-msg:Phi_Res instead.")
  (Phi_Res m))

(cl:ensure-generic-function 'Threshold-val :lambda-list '(m))
(cl:defmethod Threshold-val ((m <custom>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader walabot-msg:Threshold-val is deprecated.  Use walabot-msg:Threshold instead.")
  (Threshold m))
